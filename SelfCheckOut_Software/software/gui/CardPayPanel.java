...
public class CardPayPanel extends AbstractSCSGuiPanel {
	private static final long serialVersionUID = 6387560388567177209L;
    ...
    public CardPayPanel(SelfCheckoutStationLogic l) {
        super(l);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please tap, insert, or swipe your card");
        ...
        changePaymentTypeButton.addActionListener(evt -> scsl.scsi.exitCurrentPaymentMethod());
